...
//               str[i] = c;
//               }
char str[] = "hello it int here\nint him please\nchar me here";//\nint here if you can please find my char for me";
system("cls");
//tokenizer ver 2
char delims[] = " ";
char inte[] = "int";
...
while( result != NULL ) { //while result pointer is not null 
         ...
         if(strcmp(result, inte)!=0 && strcmp(result, chare)!=0 && strcmp(result, inten)!=0 && strcmp(result, charen)!=0 && strcmp(result, ninte)!=0){                                  
        ...
        {
            if(strcmp(result, chare)==0 || strcmp(result, charen)==0){
             colorer(result, BLUE);
             
             }
            else if(strcmp(result, inte)==0 || strcmp(result, inten)==0) 
            colorer(result, RED);
            } 
